...
<div class="max-w-xl mx-auto bg-white p-6 shadow-lg rounded-lg mt-10">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Topik</h2>

    <form action="{{ route('admin.topic.update', $topic->id) }}" method="POST" id="topikForm" class="space-y-5">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $topic->name) }}" 
                   placeholder="Contoh: Pelayanan Dokter"
